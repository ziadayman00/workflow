        ...
        <div className="bg-[#2a2a2a]/50 backdrop-blur-sm border border-[#fffbdf]/10 rounded-2xl p-6 md:p-8">
          <div className="space-y-4">
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-[#1a1a1a]/50 border border-[#fffbdf]/20 rounded-lg text-[#fffbdf] hover:border-[#fffbdf]/40 hover:bg-[#1a1a1a]/70 transition-all font-medium"
